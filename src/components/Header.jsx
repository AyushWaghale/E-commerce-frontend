    ...
    <header className="bg-background/80 backdrop-blur sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a href="/products" className="text-text hover:text-primary transition">Product</a>
          <a href="#" className="text-text hover:text-primary transition">Docs</a>

          {user ? (
            <>
              <Link to="/dashboard" className="text-text hover:text-primary transition">Dashboard</Link>
              <button
                onClick={logout}
