    ...
    <header className="bg-background/80 backdrop-blur sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <a href="/" className="text-text hover:text-primary transition">Home</a>
          <a href="#features" className="text-text hover:text-primary transition">Product</a>
          <a href="#" className="text-text hover:text-primary transition">Docs</a>
          <a href="#" className="text-text hover:text-primary transition">About</a>
          <a href="/login" className="ml-4 bg-primary text-white px-5 py-2 rounded-md font-semibold hover:bg-primary-dark transition">Login</a>
        </nav>
